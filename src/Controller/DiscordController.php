...
//TODO: falta en BBDD crear el campo Webhook con la URL de cada usuario ***********DONE

//TODO: falta hacer el metodo para que cuando uno se registra te envie el mail de validacion con el token, y te redirija a la pantalla de validacion de la cuenta, en la que tendrás que meter el mail y el token******DONE

//TODO: si coincide saldra un toaster con usuario verificado con exito y te redirigira a la pantalla de login. (SWEETER ALERT)

//TODO: los usuarios verificados si podrán loguearse, los no verificados no.**********DONE

//TODO: los canales automaticamente se pondrán como verificados y si podran ser listados en la pantalla de canales.************DONE
